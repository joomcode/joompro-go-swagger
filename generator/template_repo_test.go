...
func TestTemplates_DefinitionTargetImportPath(t *testing.T) {
	...
	var expected = "github.com/joomcode/joompro-go-swagger/fixtures"
...
func TestTemplates_FuncMap(t *testing.T) {
	...
	assert.Contains(t, rendered.String(), "\"TargetImportPath\": \"github.com/joomcode/joompro-go-swagger/generator\"")
