...
func loadGo118ClassificationPkgsCtx(t testing.TB, extra ...string) *scanCtx {
	...
	sctx, err := newScanCtx(&Options{
		Packages: append([]string{
			"github.com/joomcode/joompro-go-swagger/fixtures/goparsing/go118",
		}, extra...),
	})
...
func getGo118ClassificationModel(sctx *scanCtx, nm string) *entityDecl {
	decl, ok := sctx.FindDecl("github.com/joomcode/joompro-go-swagger/fixtures/goparsing/go118", nm)
	if !ok {
		return nil
	}
	return decl
