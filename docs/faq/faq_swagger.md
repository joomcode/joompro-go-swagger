...
Originally from issue [#1552](https://github.com/ssfilatov/go-swagger/issues/1552).
...
Originally from issue [#1501](https://github.com/ssfilatov/go-swagger/issues/1501).
...
Originally from issue [#1381](https://github.com/ssfilatov/go-swagger/issues/1381).
...
Originally from issue [#1143](https://github.com/ssfilatov/go-swagger/issues/1143).
